...
import type { DodCheck, ValidationCheck } from '../types/instructionalPlan.types'

interface DodChecklistProps {
  checklist: DodCheck[]
  automaticChecks: ValidationCheck[]
  semanticChecks: ValidationCheck[]
}
...
export function DodChecklist({ checklist, automaticChecks, semanticChecks }: DodChecklistProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      {semanticChecks.length > 0 && (
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="text-base">Validaciones Semánticas (IA)</CardTitle>
          </CardHeader>
          <CardContent className="space-y-2">
